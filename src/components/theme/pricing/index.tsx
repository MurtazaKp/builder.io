            ...
            <div className="xl:mx-auto xl:container py-20 2xl:px-0 px-6">
                <div className="lg:flex items-center justify-between">
                    <div className=" lg:w-1/2 w-full">
                        ...
                        {/* <div className="w-56">
                            <div className="bg-gray-100 shadow rounded-full flex items-center mt-10">
                                <button autoFocus className="bg-gray-100 focus:text-white focus:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none text-base leading-none text-gray-600 rounded-full py-4 px-6 mr-1" id="monthly">
                                    Monthly
                                </button>
                                <button  className="focus:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none text-base leading-none focus:text-white rounded-full py-4 px-6" id="annually">
                                    Annually
                                </button>
                            </div>
                        </div> */}
                    ...
                    <div className="xl:w-1/2 lg:w-7/12 relative w-full lg:mt-0 mt-12 md:px-8" role="list">
                        ...
                        <div role="listitem" className="bg-white group cursor-pointer shadow rounded-lg mt-3 flex relative z-30">
                        ...
                        <div role="listitem" className="bg-white group cursor-pointer shadow rounded-lg mt-3 flex relative z-30">
                            ...
                            <div className="w-full p-8">
                                <div className="md:flex items-center justify-between">
                                    <h2 className="text-2xl font-semibold leading-6 text-gray-800">Teams</h2>
                                    <p className="text-2xl md:mt-0 mt-4 font-semibold leading-6 text-gray-800">
                                        $250<span className="font-normal text-base">/mo</span>
                                    </p>
                                </div>
                                <p className="md:w-80 text-base leading-6 mt-4 text-gray-600">Unlimited products features and dedicated support channels</p>
                            </div>
                        ...
                        <div role="listitem" className="bg-white group cursor-pointer shadow rounded-lg mt-3 flex relative z-30">
                            ...
                            <div className="w-full p-8">
                                <div className="md:flex items-center justify-between">
                                    ...
                                    <p className="text-2xl md:mt-0 mt-4 font-semibold leading-6 text-gray-800">
                                        $500<span className="font-normal text-base">/mo</span>
                                    </p>
                                </div>
                                <p className="md:w-80 text-base leading-6 mt-4 text-gray-600">Unlimited products features and dedicated support channels</p>
                            </div>
